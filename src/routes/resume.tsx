...
const experience = [
  ...
  {
    role: 'Creative Director — Pitakwa 2026 Collegiate Conference | JCI Nigeria',
    company: 'Junior Chamber International Nigeria',
    period: '2025 — Present',
    description: 'Led full creative direction for a JCI Nigeria Collegiate Conference',
    'covering brand identity, visual design, and promotional strategy',
    'Designed and managed the content calendar, coordinating conference publicity across digital platforms',
    'Produced promotional flyers and visual assets maintaining cohesive, on-brand aesthetics throughout the conference',
    tags: ['Conference Brand Asset Development', 'Print', 'Content Development'],
  },
  {
    role: 'Renewable Energy Volunter/Junior Designer',
    company: 'Renew Watts Technologies, Florida, USA',
    period: '2024',
    description: 'Led creative direction for renewable energy awareness campaigns',
    'Designed promotional flyers, social media graphics, and educational materials etc',
