        ...
        <section className="py-16 md:py-24 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-muted-foreground text-lg leading-relaxed mb-6">
              I'm a graphic designer based in New York with a passion for
              building brands that resonate and designs that communicate
              with clarity and beauty. Over 6 years, I've partnered with
              startups, agencies, and established companies to turn their
              vision into compelling visual experiences.
            </p>
            <p className="text-muted-foreground leading-relaxed mb-8">
              When I'm not designing, I teach typography workshops,
              contribute to open-source design resources, and obsessively
              collect vintage poster art.
            </p>
          ...
          <div className="relative">
            <div className="aspect-[4/5] rounded-2xl bg-gradient-to-br from-primary/20 via-card to-accent/10 border border-border flex items-center justify-center overflow-hidden">
              <div className="text-center p-12">
                ...
                <p className="text-muted-foreground text-sm">Alex Morgan</p>
                <p className="text-xs text-muted-foreground/60 mt-1">Senior Graphic Designer</p>
              </div>
            </div>
            {/* Floating badges */}
            <div className="absolute -bottom-4 -left-4 bg-card border border-border rounded-xl px-4 py-3 shadow-xl">
              <p className="font-display font-bold text-2xl text-primary">120+</p>
              <p className="text-xs text-muted-foreground">Projects</p>
            </div>
            <div className="absolute -top-4 -right-4 bg-card border border-border rounded-xl px-4 py-3 shadow-xl">
              <p className="font-display font-bold text-2xl text-accent">6+</p>
